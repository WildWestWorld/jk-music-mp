...
__DEFINE__(1652167729494, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1652167729495,"./event-store":1652167729496}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652167729495, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1652167729496, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1652167729495,"./utils":1652167729497}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652167729497, function(require, module, exports) {
...
return __REQUIRE__(1652167729494);
})()
